...
Callback.addCallback("PostLoaded", function() {
	...
	tTHeight = UI.getScreenHeight() + EMCForItems.length * (listSlotScale + listSlotSpace);
    Recipes.addShaped({
            ...
            if (this.data.shallTransfer == 0 || (World.getBlockID(this.data.placeToTransfer["x"], this.data.placeToTransfer["y"], this.data.placeToTransfer["z"])==BlockID.energyCondenser && World.getTileEntity(this.data.placeToTransfer["x"], this.data.placeToTransfer["y"], this.data.placeToTransfer["z"]).hasFreeSpace()==-1)) {
				...
				if(mainContainer.getSlot("burnSlot").id!=0){
					if(Item.getName(mainContainer.getSlot("burnSlot").id, 0).indexOf(partOfStar)!=-1){
						...
						if (mainContainer.getSlot("burnSlot").id == 0 && mainContainer.getSlot("slot12").id != 0 && collectorRecipes[mainContainer.getSlot("slot12").id + "" + mainContainer.getSlot("slot12").data] != undefined) {
            ...
            if (this.data.shallTransfer == 0 || (World.getBlockID(this.data.placeToTransfer["x"], this.data.placeToTransfer["y"], this.data.placeToTransfer["z"])==BlockID.energyCondenser && World.getTileEntity(this.data.placeToTransfer["x"], this.data.placeToTransfer["y"], this.data.placeToTransfer["z"]).hasFreeSpace()==-1)) {
				...
				if(mainContainer.getSlot("burnSlot").id!=0){
					if(Item.getName(mainContainer.getSlot("burnSlot").id, 0).indexOf(partOfStar)!=-1){
						...
						if (mainContainer.getSlot("burnSlot").id == 0 && mainContainer.getSlot("slot16").id != 0 && collectorRecipes[mainContainer.getSlot("slot16").id + "" + mainContainer.getSlot("slot16").data] != undefined) {
...
TileEntity.registerPrototype(BlockID.antiMatterTier1, {
    ...
    tick: function() {
        if (World.getThreadTime() % 5 == 0) {
            ...
            if (this.container.getSlot("burnSlot").id != 0 && Item.getName(this.container.getSlot("burnSlot").id, 0).indexOf(partOfStar)==-1 && getEMC(this.container.getSlot("burnSlot").id, this.container.getSlot("burnSlot").data) != -1) {
			...
			if(Item.getName(this.container.getSlot("wandSlot").id, 0).indexOf(partOfStar)!=-1){
